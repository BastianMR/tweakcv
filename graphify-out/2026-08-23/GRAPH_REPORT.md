# Graph Report - TweakCV  (2026-08-23)

## Corpus Check
- 99 files · ~36,926 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 678 nodes · 1028 edges · 95 communities (41 shown, 54 thin omitted)
...
4. `Quickstart: Validación end-to-end TweakCV MVP` - 17 edges
5. `useT()` - 16 edges
6. `AGENTS.md Agent Instructions` - 14 edges
7. `registerDocumentRoutes()` - 13 edges
8. `tweakcv README` - 13 edges
9. `dataDir()` - 12 edges
10. `ApiError` - 12 edges
...
- `Test Step (npm test)` --calls--> `Command: npm test`  [EXTRACTED]
  .github/workflows/ci.yml → README.md
- `Typecheck Step (npm run typecheck)` --calls--> `Command: npm run typecheck`  [EXTRACTED]
  .github/workflows/ci.yml → README.md
...
Cohesion: 0.06
Nodes (36): AiClient, AiClientOptions, AiConfig, AiError, AiErrorCode, CompleteJsonInput, createAiClient(), PRESET_BASE_URLS (+28 more)
...
Cohesion: 0.07
Nodes (45): api, ApiClientError, ApiErrorShape, Health, ProfileFull, SkillRow, useActivateProfile(), useActiveProfile() (+37 more)

### Community 3 - "education.ts"
Cohesion: 0.28
Nodes (6): yearMonthSchema, Education, EducationCreate, educationInputSchema, educationSchema, educationStatusSchema
...
Cohesion: 0.07
Nodes (27): ajv, better-sqlite3, hono, @hono/node-server, @jsonresume/schema, openai, dependencies, ajv (+19 more)
...
Cohesion: 0.10
Nodes (19): allowScripts, better-sqlite3@13.0.3, esbuild@0.28.2, puppeteer@25.8.0, description, engines, node, license (+11 more)

### Community 9 - "log.ts"
Cohesion: 0.15
Nodes (14): createLogger(), emit(), LEVELS, logFilePath(), Logger, LogLevel, LogLine, maxBytes() (+6 more)
...
### Community 18 - "collections.ts"
Cohesion: 0.07
Nodes (59): createApp(), dataDir(), getDb(), Column, makeCrud(), WithId, applyImport(), buildImportPreview() (+51 more)

### Community 19 - "profile"
Cohesion: 0.36
Nodes (8): education, experience, profile, project, skill, assessment, document, imported_entity
...
Cohesion: 0.32
Nodes (6): educationCreateSchema, Contact, contactSchema, ProfileCreate, profileCreateSchema, profileSchema
...
### Community 92 - "experience.ts"
Cohesion: 0.33
Nodes (5): Experience, ExperienceCreate, experienceCreateSchema, experienceInputSchema, experienceSchema

### Community 93 - "project.ts"
Cohesion: 0.33
Nodes (5): Project, ProjectCreate, projectCreateSchema, projectInputSchema, projectSchema

## Knowledge Gaps
- **263 isolated node(s):** `name`, `version`, `description`, `type`, `license` (+258 more)
...
- **Why does `ApiError` connect `collections.ts` to `ai/client.ts`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `getDb()` connect `collections.ts` to `ai/client.ts`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `api` connect `queries.ts` to `api/documents.ts`?**
